...
const { userRegister, userLogin, sendOtpPassword, companySignup, resetPassword, userKyc, companyKyc, addLanguage, userEditProfile, verifyUser, updateLanguage, userResetPassword } = require("../controllers/userControllers.js/register")
const upload = require("../middleware/multer")
const tokenAuthorisationUser = require("../middleware/userAuthentication")
const { createIdea, listBussinesIdeas, searchBussinessIdea, addBids, baseBidList, myBussinessIdea, lowtoHighPrice, highToLowPrice, updateBussinessIdea } = require("../controllers/userControllers.js/product")
const { pushNotification, PrivacyUser, createReports } = require("../controllers/userControllers.js/notification")
const { categoryList, subCategoryList } = require("../controllers/adminControllers/categoryController")
const { createPayment } = require("../controllers/userControllers.js/orderControllers")
